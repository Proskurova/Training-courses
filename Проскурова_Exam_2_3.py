...
print('Порядковый номер минимального элемента С_1:', C_1.index(min(C_1)), '; и С_2:', C_2.index(min(C_2)))
print('Порядковый номер максимального элемента С_1:', C_1.index(max(C_1)), '; и С_2:', C_2.index(max(C_2)))